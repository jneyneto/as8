...
export default function Footer() {
  return (
    <div className="home-footer-position">
      <footer className="home-footer">
        <div className="home-footer-nav">
          <h5 className="qualquercoisa-footer-title">Navegação</h5>
        ...
        <div className="home-footer-nav">
          <h5 className="qualquercoisa-footer-title">Imóveis</h5>
          <h5 className="qualquercoisa-footer">Compra</h5>
          <h5 className="qualquercoisa-footer">Locação</h5>
        </div>

        <div className="home-footer-nav">
          <h5 className="qualquercoisa-footer-title">Atendimento</h5>
